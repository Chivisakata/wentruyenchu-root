...
(4, 'Ta Thân Ái Pháp Y Tiểu Thư', 'Tửu Noãn Xuân Thâm', 'Trinh Thám, Nữ Cường, Bách Hợp', NULL, 'Đang ra', 'Trong \"Nỗi bi thảm của thế giới\", Victor Hugo viết rằng<br><br>\"Nhân tâm, vừa có thể tỏa ra muôn vàn quang minh, đồng thời cũng dựng lên vô tận hắc ám.<br><br>Ánh sáng cùng bóng tối, đan xen nhau, tranh đấu, tàn sát nhau.<br><br>Cũng là nguyên do mà ta lưu luyến nhân gian, đồng thời dâng lên niềm tiếc hận\".<br><br>Tra án, đoán tâm, thăm dò.<br><br>\"Ngươi biết nhân sinh khó khăn nhất là gì không?\"<br><br>\"Không phải tương ngộ, là cửu biệt trùng phùng.', '2026-03-11 20:42:14', 'tathanaiphapytieuthu.jpg'),
